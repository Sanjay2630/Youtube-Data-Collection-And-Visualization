...
client=pymongo.MongoClient('mongodb+srv://sandhiyag21102003:sanjayh@cluster0.gmfqhhi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
...
#streamlit part
im = Image.open('Bar-Chart-Vertical.png')
st.set_page_config(page_title="Youtube Data Analysis", layout="wide",page_icon=im)
page_color_map = {
    "Light Green": "#E8F5E9",
    "Light Blue": "#E3F2FD",
    "Light Grey": "#F5F5F5",
